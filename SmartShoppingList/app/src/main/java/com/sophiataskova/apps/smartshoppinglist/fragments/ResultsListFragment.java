...
public class ResultsListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(com.sophiataskova.apps.smartshoppinglist.R.layout.fragment_results_list, container, false);
//        swipeContainer = (SwipeRefreshLayout) v.findViewById(R.id.swipeContainer);
        ...
        lvShoppingList = (ListView) v.findViewById(com.sophiataskova.apps.smartshoppinglist.R.id.lv_shopping_list);
